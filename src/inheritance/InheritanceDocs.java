...
public class InheritanceDocs {
	 ...
	 *  # we can't inherit private properties and methods from parent class
	 *  # we can inherit static props. and methods.
	 *  # Constructors are not inherited.
	 *  # 'super' keyword is use to represent parent object.
	 *     we can access properties,methods and constructors of parent class
	 *     to child class through 'super' keyword.
	 *     
